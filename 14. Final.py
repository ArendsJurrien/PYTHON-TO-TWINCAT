...
# Functie om een bericht naar TwinCAT te sturen
def send_text_to_twincat(text, plc, variable_name="Main.status_message"):
    try:
    ...
    try:
        ...
        while True:
            if not processing:
                ...
                send_text_to_twincat("Waiting for start pulse...", plc)
                while not check_start_pulse(plc):
                    time.sleep(0.1)  # Controleer periodiek op de startpuls

                # Start run mode
                send_text_to_twincat("Run mode started", plc)
            ...
            while processing:
                ...
                if check_start_pulse(plc):
                    send_text_to_twincat("Restarting process", plc)
                ...
                if elapsed_time > timeout_seconds:
                    send_text_to_twincat("Timeout. No gear found.", plc)
                    ...
                    if 0.7 < contour_area / circle_area < 1.0:
                        ...
                        if depth_at_center > 0:
                            ...
                            if min_diameter_mm <= diameter_mm <= max_diameter_mm:
                                ...
                                send_text_to_twincat("Gear found", plc)
                                ...
                                send_text_to_twincat("Sending coordinates", plc)
                                send_coordinates_to_twincat(x_coords_mm, y_coords_deg)
                                send_text_to_twincat("Coordinates succesfully sended", plc)
                                ...
                                send_text_to_twincat("Process completed", plc)
